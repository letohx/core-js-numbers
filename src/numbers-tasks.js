 ...
 *   0    => 0
 */
const getCircleCircumference = (radius) => radius * 2 * Math.PI;
 ...
 *  -3, 3  => 0
 */
const getAverage = (value1, value2) => value1 * 0.5 + value2 * 0.5;
...
function getDistanceBetweenPoints(x1, y1, x2, y2) {
  const legX = Math.abs(x1 - x2);
  const legY = Math.abs(y1 - y2);
...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  const angleRadians = Math.atan2(y2, x2) - Math.atan2(y1, x1);

  return angleRadians < 0 ? angleRadians + 2 * Math.PI : angleRadians;
}
 ...
 *     0     => 0
 */
const getLastDigit = (value) => value.toString().slice(-1);
 ...
 * 2, 2    => '10'
 */
const numberToStringInBase = (num, base) => num.toString(base);
 ...
 * 12345, 2    => '1.23e+4'
 */
const toExponential = (num, fractionDigits) =>
 ...
 * 12.345, 1   => '12.3'
 */
const toFixed = (num, fractionDigits) => num.toFixed(fractionDigits);
 ...
 * Number(-5)    => -5
 */
const getNumberValue = (num) => num.valueOf();
 ...
 * -5.1 => -6
 */
const roundToSmallestInteger = (num) => Math.floor(num);
 ...
 * -5.9 => -5
 */
const roundToLargestInteger = (num) => Math.ceil(num);
 ...
 * -5.5 => -5
 */
const getIntegerPartNumber = (num) => Math.trunc(num);
 ...
 * 0.1, 0.2, 0.3 => 0.6
 */
const getSumOfNumbers = (x1, x2, x3) => (x1 + x2 + x3).toPrecision(10);
 ...
 * 0, 5   => 5
 */
const getMaxNumber = (firstNum, secondNum) => Math.max(firstNum, secondNum);
...
function getCountOfOddNumbers(num) {
  ...
  return num % 2 === 0 ? abs / 2 : Math.ceil(abs / 2);
}
